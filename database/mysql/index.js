...
const checkConfigParameter = config => {
    if (!config) throw new Error('No configuration; please provide a config for the DB connection');
    if (!config.host) throw new Error('No host in config; please provide a host name in the config object');
    if (!config.user) throw new Error('No user in config; please provide a user name in the config object');
    if (!config.database) throw new Error('No database in config; please provide a database name in the config object');
    if (!config.password) throw new Error('No password in config; please provide a password in the config object');
};

checkConfigParameter(defaultConfig);
